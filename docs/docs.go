    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/projectmembers.AddProjectMemberRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/workspaces": {
            "post": {
                ...
                "description": "Creates a workspace for the authenticated user in a project",
                "produces": [
                    "application/json"
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "projects.Project": {
            ...
            "properties": {
                ...
                "deletedYN": {
                    "$ref": "#/definitions/users.DeleteYn"
                },
                "environment": {
                    "type": "string"
                },
